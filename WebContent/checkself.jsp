...
<div id="mainmenu">
<h1 align="center">欢迎!!!您可以查看您的个人信息!!!</h1>
...
<tbody>
<%
List<Man> slist = (List<Man>)session.getAttribute("slist");
for(Man man : slist) {
	out.println("<tr>");
	out.println("<td>"+man.getId()+"</td>");
	out.println("<td>"+man.getPwd()+"</td>");
	out.println("<td>"+man.getName()+"</td>");
	out.println("<td>"+"<a href='check.action?userid="+man.getId()+"&type=modifyself'>修改</a>"+"</td>");
	out.println("</tr>");
}
%>
</tbody>
